...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText passwordText=(EditText)findViewById(R.id.password1);
        phoneText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if(StringUtils.equalsNull(phoneText.getText().toString())||StringUtils.equalsNull(passwordText.getText().toString())){
                    int tint = Color.parseColor("white");
                    btn3 .getBackground().setColorFilter(tint, PorterDuff.Mode.DARKEN);
                    notEmpty=false;
                }else{
